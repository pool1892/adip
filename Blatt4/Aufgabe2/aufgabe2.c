...
long long int fakultaet(long long);
long long int biko (long long, long long);
...
if(a<0) {printf("Fakultät für negative Zalen nicht definiert");return 0;}
if(a==1 || a==0) {return 1;}
else {a=a*fakultaet(a-1); return a;}
}
